<script lang="ts">
	...
	const deleteThis = (main: boolean, id: number) => {
		...
		if (images.length === 0) primera_imagen = true;
		if (main) images[0].main = true;
	};
		...
		<label for="laImagen">
			<div class="flex ">
				<div class="flex flex-col justify-center items-center max-w-md ">
					<div
						class="bordered border-4 border-sky-500 rounded-full w-9 h-9 flex justify-center items-center"
					>
