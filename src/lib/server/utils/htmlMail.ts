...
const detail = (productos:OrdenDePedidoProducto[]) => {
    ...
    export const htmlTable = (order:string) => {
      const orden = JSON.parse(order);
      const detalle = detail(orden.detalle);
      const table = `
      <!DOCTYPE html>
                    ...
                    <tr>
                      <td class="sm-px-6" style="border-radius: 4px; background-color: #fff; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)">
                        ...
                        <div style="margin-left: 40px; margin-right: 40px">
                          ...
                          <p>
                            ${orden.ciudad_ent}, ${orden.departamento_ent}
                          </p>
                        </div>
                        <p>
